  ...
  <div class="volunteer-activity-container">
    ...
    >
      <el-table :data="participants" v-loading="participantLoading">
        ...
        <el-table-column prop ="serviceHours" label="服务时长" width="150">
...
const API = {
  getActivities: '/api/volunteer_info',
...
const rules = reactive({
  ...
  organizer: { required: true, message: '请输入活动组织者', trigger: 'blur' },
...
const loadActivities = async () => {
  try {
    loading.value = true
    const response = await axios.get( '/api/volunteer_info')
